...
| **ROCHADE** | Sistema de gestión de código fuente en el que se almacenan las aplicaciones Natural. |
...
| **TODE** | Aplicación vinculada al menú principal. Controlador del sistema de menús SILCON. |
...
graph TB
    ...
    TODE --> D1 & D1C & D2 & D3 & D4 & D5 & D6 & D7 & D8 & D9
    D1 & D1C --> ZODIACSU
    D2 --> ZODEACSU
    D3 --> ZODACCCU
    D4 --> ZOFICACU
...
| `TRE16` | `TRET2013` | Alta de datos económicos (clave presupuesto). |
...
| Proceso | Programa | Función |
|---------|----------|---------|
| `TRE13` | `TRET1084` | Notas y propuestas de liquidación de capital coste. |
| `TRE14` | `TRET1085` | Reimpresión de notas y PL de capital coste. |
...
|--------|---------|---------|---------|
| `TRET1084` | Notas y PL de capital coste | `TCCN8B01`, `TCCNP234` | — |
| `TRET1085` | Reimpresión notas y PL | `TCCN8B01`, `TCCNP234` | `ZODCCACU` |
...
| `TRET1084` | `TCCN8B01`, `TCCNP234` | `TCCLP234` |
...
| `TRE35` | `TRET2341` | Actualización y consulta de emisiones. |
| `TRE36` | `TRET2351` | Informe del presupuesto. |
| `TRE37` | `TRET2352` | Estadística presupuestaria (OK's). |
| `TRE38` | `TRET2353` | Estadística presupuestaria (fechas). |
| `TRE75` | `TRET2354` | Emisión de impugnaciones. |
...
| `TRETA8` | `TRETA800` | Consulta de datos del expediente para emisiones. |
...
| `TRET2341` | Actualización y consulta | `GP0PN003`, `GP0PN011`, `TCCN8001`, `TCCNP234` | — |
| `TRET2351` | Informe presupuesto | `TCCN7002`, `TCCNP234` | `ZODACOPU` |
| `TRET2352` | Estadística OK's | `TCCN8B01`, `TCCNP234` | — |
| `TRET2353` | Estadística fechas | `TCCN8B01`, `TCCNP234` | `ZODACOPU` |
| `TRET2354` | Emisión impugnaciones | `TCCN8B01`, `TCCNP234` | `ZODACOPU` |
...
| `TRETA800` | Consulta datos expediente para emisiones | `TCCNP234`, `TREN202H` | `ZODIACSU`, `ZODACCCU`, `ZODCCACU`, `ZODEACSU`, `ZOETACDU`, `ZOFICACU`, `ZOMUPATU` |
...
| `TRETA800` | `TCCNP234`, `TREN202H` | `ZODIACSU`, `ZODACCCU`, `ZODCCACU`, `ZODEACSU`, `ZOETACDU`, `ZOFICACU`, `ZOMUPATU` |
...
| `TRE51` | `TRET4102` | Modificación de mutuas y compañías aseguradoras. |
| `TRE52` | `TRET4103` | Visualización de mutuas y compañías aseguradoras. |
| `TRE53` | `TRET4104` | Consulta general de mutuas y compañías aseguradoras. |
| `TRE54` | `TRET4105` | Informe impreso de mutuas (RE7). |
| `TRE55` | `TRETA600` | Informe de expedientes de mutuas absorbidas. |
...
| `TRET4102` | Modificación mutuas | `TCCNP234` | `ZOMUPATU` |
| `TRET4103` | Visualización mutuas | `CVALIBAN`, `GP0PN003`, `RSNN9001`, `RSNN9003`, `TCCN8001`, `TCCNP234` | `ZOMUPATU` |
| `TRET4104` | Consulta general mutuas | `TCCNP234` | `ZOMUPATU` |
| `TRET4105` | Informe impreso RE7 | `TCCN8001`, `TCCN8B01`, `TCCNP234` | — |
| `TRETA600` | Informe mutuas absorbidas | `TCCN8B01`, `TCCNP234` | `ZOMUPATU` |
...
| `TRE57` | `TRET4202` | Modificación de límite de responsabilidad. |
| `TRE58` | `TRET4203` | Visualización de límite de responsabilidad. |
| `TRE59` | `TRET4204` | Baja de límite de responsabilidad. |
| `TRE60` | `TRET4205` | Consulta general de límites de responsabilidad. |
| `TRE61` | `TRET4206` | Informe impreso de límites de responsabilidad. |
...
| `TRET4202` | Modificación límite responsabilidad | `TCCNP234` | `ZOLIREMU` |
| `TRET4203` | Visualización límite responsabilidad | `GP0PN011`, `TCCNP234` | `ZOLIREMU`, `ZOMUPATU` |
| `TRET4204` | Baja límite responsabilidad | `TCCNP234` | `ZOLIREMU`, `ZOMUPATU` |
| `TRET4205` | Consulta general | `TCCN8B01`, `TCCNP234` | — |
| `TRET4206` | Informe impreso | `GP0PN011`, `TCCN8B01`, `TCCNP234` | `ZOLIREMU`, `ZOMUPATU` |
| `TRET4300` | Consulta de mutuas (mantenimiento especial) | `TCCN8B01`, `TCCNP234` | `ZOMUPATU` |
...
| Proceso | Programa | Función |
|---------|----------|---------|
| `TRE12` | `TRET1070` | Estadísticas por periodo (selección de expedientes). |
...
| `TRE81` | `TRET3090` | Informe de P.R. |
| `TRE92` | `TRET8000` | Expedientes sin P.R. |
| `TRE93` | `TRET3091` | Informe historial expedientes A.T. |
| `TRE97` | `TRETFP10` | Fichero presupuesto gasto. |
...
| Módulo | Función | CALLNAT | VIEW OF |
|--------|---------|---------|---------|
| `TRET1070` | Estadísticas por periodo | `TCCN8B01`, `TCCNP234`, `TREN1070` | — |
...
| `TRET3090` | Informe de P.R. | `TCCN8001`, `TCCNP234` | — |
| `TRET3091` | Informe historial A.T. | `GP0PN015`, `TCCN8001`, `TCCNP234` | `ZOMUPATU` |
| `TRET8000` | Expedientes sin P.R. | `TCCN8001`, `TCCNP234` | — |
| `TRETB400` | Estadísticas armario digital | `TCCN8001`, `TCCNP234` | — |
| `TRETFP10` | Fichero presupuesto gasto | — | `ZODINOPU` |

#### 10.3.2 Subprogramas (TREN*)

| Módulo | Función | Invocado por |
|--------|---------|-------------|
| `TREN1070` | Consulta con selección de expedientes para estadísticas por periodo. | `TRET1070` |
...
| `TRE82` | `TRET6010` | Consulta de ficheros del INSS cargados. |
...
| `TRET6010` | Consulta ficheros INSS cargados | `TCCN8001`, `TCCNP234`, `TREN202H` | `ZODIACSU`, `ZODCCACU`, `ZODEACSU`, `ZOETACDU`, `ZOFICACU`, `ZOINCACU` |
...
| `TRE91` | `TRET9300` | Gestión de expedientes. |
| `TRE94` | `TRET9100` | Alta de registro del Armario Digital (fase II). |
...
| `TREAB` | `TRET9700` | Actualización porcentaje de responsabilidad. |
...
| Módulo | Función | CALLNAT | VIEW OF |
|--------|---------|---------|---------|
| `TRET9100` | Alta registro A.D. (fase II) | `GP0PN003`, `TCCN8001`, `TCCNP234`, `TREN9100` | `ZOINCACU` |
| `TRET9300` | Gestión de expedientes | `TCCN8001`, `TCCNP234` | `ZODIACSU` |
...
| `TRET9700` | Actualización % responsabilidad | `TCCN8001`, `TCCNP234` | `ZODEACSU` |
...
| `TREN202H` | Lectura y presentación datos auxiliares | D2, D4 (Emisiones), D8 (INSS) |
...
| `TRE12` | `TRET1070` | — (batch) |
| `TRE13` | `TRET1084` | — (batch) |
| `TRE14` | `TRET1085` | `ZODCCACU` |
...
| `TRE35` | `TRET2341` | — |
| `TRE36` | `TRET2351` | `ZODACOPU` |
| `TRE37` | `TRET2352` | — (batch) |
| `TRE38` | `TRET2353` | `ZODACOPU` |
...
| `TRE51` | `TRET4102` | `ZOMUPATU` |
| `TRE52` | `TRET4103` | `ZOMUPATU` |
| `TRE53` | `TRET4104` | `ZOMUPATU` |
| `TRE54` | `TRET4105` | — (batch) |
| `TRE55` | `TRETA600` | `ZOMUPATU` |
| `TRE56` | `TRET4201` | `ZOLIREMU`, `ZOMUPATU` |
| `TRE57` | `TRET4202` | `ZOLIREMU` |
| `TRE58` | `TRET4203` | `ZOLIREMU`, `ZOMUPATU` |
| `TRE59` | `TRET4204` | `ZOLIREMU`, `ZOMUPATU` |
| `TRE60` | `TRET4205` | — (batch) |
| `TRE61` | `TRET4206` | `ZOLIREMU`, `ZOMUPATU` |
...
| `TRE75` | `TRET2354` | `ZODACOPU` |
| `TRE81` | `TRET3090` | — (batch) |
| `TRE82` | `TRET6010` | `ZODIACSU`, `ZODCCACU`, `ZODEACSU`, `ZOETACDU`, `ZOFICACU`, `ZOINCACU` |
...
| `TRE91` | `TRET9300` | `ZODIACSU` |
| `TRE92` | `TRET8000` | — (batch) |
| `TRE93` | `TRET3091` | `ZOMUPATU` |
| `TRE94` | `TRET9100` | `ZOINCACU` |
| `TRE95` | `TRET2800` | `ZODIACSU`, `ZODCCACU`, `ZODEACSU`, `ZOETACDU`, `ZOFICACU` |
| `TRE96` | `TRET9600` | — (vía `TREN2020`) |
| `TRE97` | `TRETFP10` | `ZODINOPU` |
...
| DDM | Procesos |
|-----|----------|
| **ZODIACSU** | TRE00–TRE08, TRE15–TRE17, TRE19, TRE23–TRE26, TRE30, TRE39–TRE40, TRE44–TRE46, TRE64, TRE82, TRE89, TRE91, TRE95, TREA0–TREA2, TREB5, TREB6, TREB8, TRE9400 |
| **ZODEACSU** | TRE02, TRE04–TRE05, TRE15–TRE17, TRE19, TRE23–TRE26, TRE30, TRE34, TRE39–TRE40, TRE65–TRE66, TRE82, TRE95, TREA0–TREA2, TREAB, TREB6, TRE9400 |
| **ZODACCCU** | TRE04, TRE14, TRE23, TRE66, TREA4 |
| **ZOFICACU** | TRE02, TRE15, TRE19, TRE23–TRE26, TRE66, TRE82, TRE85, TRE90, TRE95, TREA0–TREA2, TREA7, TREB6, TREB8 |
| **ZOMUPATU** | TRE01–TRE02, TRE30, TRE39–TRE40, TRE50–TRE55, TRE56, TRE58–TRE59, TRE61, TRE64, TRE88, TRE93, TREB5, TREB6, TRE9400 |
| **ZOLIREMU** | TRE01–TRE02, TRE39, TRE56–TRE61, TRE64 |
| **ZOETACDU** | TRE01–TRE04, TRE15–TRE17, TRE19, TRE23–TRE26, TRE30, TRE62–TRE64, TRE82, TRE89, TRE95, TRE98, TREA0–TREA2, TRE9400 |
| **ZOINCACU** | TRE04, TRE26, TRE67–TRE70, TRE82, TRE88, TRE94, TREA1–TREA2, TREA5, TREA9, TRE9400 |
...
|---------------|----------------|----------------------|-------------|
| `TRE12` | `TRET1070` | `TCCN8B01` → JCL | Estadísticas por periodo. |
| `TRE13` | `TRET1084` | `TCCN8B01` → JCL | Notas y PL de capital coste. |
| `TRE14` | `TRET1085` | `TCCN8B01` → JCL | Reimpresión de notas y PL. |
...
| `TRE37` | `TRET2352` | `TCCN8B01` → JCL | Estadística presupuestaria OK's. |
| `TRE38` | `TRET2353` | `TCCN8B01` → JCL | Estadística presupuestaria fechas. |
...
| `TRE60` | `TRET4205` | `TCCN8B01` → JCL | Consulta general de límites. |
| `TRE61` | `TRET4206` | `TCCN8B01` → JCL | Informe impreso de límites. |
| `TRE75` | `TRET2354` | `TCCN8B01` → JCL | Emisión de impugnaciones. |
| `TRE81` | `TRET3090` | `TCCN8001` → JCL | Informe de P.R. |
| `TRE87` | `TRET6015` | `TCCN8001` → JCL | Informe pendientes INSS. |
| `TRE92` | `TRET8000` | `TCCN8001` → JCL | Expedientes sin P.R. |
